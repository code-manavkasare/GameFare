    ...
    return (
      <Animated.View style={[styles.header, {borderColor: '#eaeaea'}]}>
        <Row style={{width: width}}>
          <Col
            size={15}
            style={[styles.center2, {paddingLeft: 10}]}
            activeOpacity={0.4}
            onPress={() => this.back()}>
          ...
          <Col size={70} style={styles.center}>
            <Row>
              <Col style={styles.center} size={20}>
                <Animated.View
                  style={[styles.roundStep, {backgroundColor: colors.primary}]}>
                  <Animated.Text style={[styles.textButton, {color: 'white'}]}>
                    1
                  </Animated.Text>
                </Animated.View>
              </Col>
              <Col style={styles.center} size={10}>
                <Animated.View
                  style={[
                    styles.line,
                    {backgroundColor: this.props.backgroundColorLine1},
                  ]}
                />
              </Col>
              <Col style={styles.center} size={20}>
                <Animated.View
                  ...
                  <Animated.Text
                    style={[styles.textButton, {color: this.props.textColor2}]}>
                    2
                  </Animated.Text>
                </Animated.View>
              </Col>
              <Col style={styles.center} size={10}>
                <Animated.View
                  style={[
                    styles.line,
                    {backgroundColor: this.props.backgroundColorLine2},
                  ]}
                />
              </Col>
              <Col style={styles.center} size={20}>
                <Animated.View
                  style={[
                    styles.roundStep,
                    {
                      backgroundColor: this.props.backgroundColor3,
                      borderColor: this.props.borderColor3,
                    },
                  ]}>
                  <Animated.Text
                    style={[styles.textButton, {color: this.props.textColor3}]}>
                    3
                  </Animated.Text>
                </Animated.View>
              </Col>
