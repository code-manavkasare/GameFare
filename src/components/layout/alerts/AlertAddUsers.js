...
export default class AlertAddUsers extends Component {
  constructor(props) {
    super(props);
    this.state = {
      step: 1,
  ...
  subtitle() {
    if (this.props.navigation.getParam('subtitle'))
      return (
        <Text
          style={[
            styleApp.text,
            {marginTop: 20, fontFamily: 'OpenSans-Regular', fontSize: 15},
          ]}>
  ...
  cardUser(user, key) {
    return <Row key={key} style={{marginLeft: 20, width: width - 40}}></Row>;
  }
  render() {
      ...
      <View style={styles.viewModal}>
        ...
        <View style={styles.viewButton}>
          <Button
            ...
            text={this.props.navigation.getParam('textButton')}
            click={() => this.click()}
