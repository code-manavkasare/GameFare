...
class Page0 extends Component {
  ...
  async setCoach(val) {
    ...
    await this.props.navigation.navigate('Alert', {
      ...
      onGoBack: () => this.sendMessage(),
      title: 'Access required.',
      subtitle:
        'You need to become a verified instructor in order to create an instructor events.',
      icon: (
        <AllIcons
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              this.props.createEventAction('setStep0', {
                ...
                joiningFee: !this.props.step0.coachNeeded
                  ? sport.fee.coachMatchFee
                  : '',
                free: false,
              })
            }>
            <Row>
              <Col size={15} style={styleApp.center}>
                <AllIcons
                  ...
                  type="mat"
                  color={
                    !this.props.step0.coachNeeded ? colors.grey : colors.green
                  }
                  size={23}
                />
              </Col>
              <Col size={85} style={[styleApp.center2, {paddingLeft: 15}]}>
                <Text
                  style={[
                    ...
                    {
                      fontSize: 17,
                      color: !this.props.step0.coachNeeded
                        ? colors.grey
                        : colors.green,
                    },
                  ]}>
  ...
  entreeFeeSection(state) {
    return (
      <Row
        style={{height: 60, marginTop: 15, paddingRight: 20, paddingLeft: 20}}>
          ...
          <Row style={{height: 55, width: '100%'}}>
            <Col style={styleApp.center}>
              <AllIcons
                name="check"
                type="font"
                color={this.props.step0.free ? colors.primary : colors.grey}
                size={16}
              />
            </Col>
        ...
        {!this.props.step0.coachNeeded ? (
          ...
          <View style={styleApp.marginView}>
            <Text
              ...
              We are happy to match you with an instructor. Every player will be
              charged{' '}
              <Text
                style={{fontFamily: 'OpenSans-SemiBold', color: colors.title}}>
                ${sport.fee.coachMatchFee}
              </Text>{' '}
              to participate, which will be payment for the instructor.
            </Text>
          </View>
        )}
      </View>
