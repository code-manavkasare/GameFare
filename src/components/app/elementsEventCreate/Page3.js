    ...
    console.log(data)
      ...
      return (
        <View style={[styleApp.marginView,{paddingTop:15}]}>
          ...
          {data.date.recurrence != ''?this.rowIcon('stopwatch',this.title(data.date.recurrence.charAt(0).toUpperCase() + data.date.recurrence.slice(1) + ' recurrence'),'font'):null}
    ...
    return (
      <View style={[styleApp.stylePage,{borderLeftWidth:1}]}>
        ...
        <ScrollView 
          ...
          contentScrollView={() => this.page2(this.props.navigation.getParam('data'),this.props.navigation.getParam('sport'))}
