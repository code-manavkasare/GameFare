  ...
  render() {
    return (
        <View style={[styles.content]}>
          ...
          <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}   colors={[colors.placeHolder1, colors.placeHolder2]} style={{height:280,marginBottom:30}} />
          ...
          <View style={styleApp.divider2} />
            ...
            <Row style={{height:40}}>
              <Col size={15} style={styleApp.center}>
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}   colors={[colors.placeHolder1, colors.placeHolder2]} style={{height:35,width:35,borderRadius:17.5}} />
              </Col>
              <Col size={85} style={styleApp.center2}>
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}   colors={[colors.placeHolder1, colors.placeHolder2]} style={{height:20,width:100,borderRadius:3}} />
              </Col>
            </Row>
            <Row style={{height:40}}>
              <Col size={15} style={styleApp.center}>
            ...
            <Row style={{marginTop:0,height:100}}>
              <Col style={styleApp.center}>
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}   colors={[colors.placeHolder1, colors.placeHolder2]} style={{height:60,width:60,borderRadius:30}} />
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}   colors={[colors.placeHolder1, colors.placeHolder2]} style={{height:20,width:95,borderRadius:3,marginTop:10}} />
              </Col>
              <Col style={styleApp.center}>
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}   colors={[colors.placeHolder1, colors.placeHolder2]} style={{height:60,width:60,borderRadius:30}} />
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}   colors={[colors.placeHolder1, colors.placeHolder2]} style={{height:20,width:95,borderRadius:3,marginTop:10}} />
